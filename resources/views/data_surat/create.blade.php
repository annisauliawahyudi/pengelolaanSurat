...
@section('tittle', 'Tambah Data Surat')
...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('letter.create') }}">Tambah Data Surat</a>
            </li>
        </ol>
    </nav>
    <!-- End Breadcrumb -->
